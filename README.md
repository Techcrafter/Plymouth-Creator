...
On Debian based systems, open the file "RUN ME.sh" in the terminal to install the needed dependencies. Alternatively, install the dependencies manually from [#dependencies](#dependencies).
