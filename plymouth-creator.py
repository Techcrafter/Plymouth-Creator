...
class Handler:
  ...
  def on_generateButton_clicked(self, button):
    ...
    installFile.write("plymouth --show-splash\n")
    installFile.write("sleep 10\n")
    installFile.write("plymouth quit\n")
    installFile.write("echo Done!\n")
    ...
    testFile.write("plymouth --show-splash\n")
    testFile.write("sleep 10\n")
    testFile.write("plymouth quit\n")
    ...
    uninstallFile.write("plymouth --show-splash\n")
    uninstallFile.write("sleep 10\n")
    uninstallFile.write("plymouth quit\n")
    uninstallFile.write("echo Done!\n")
